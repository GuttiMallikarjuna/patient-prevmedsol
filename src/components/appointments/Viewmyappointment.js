      ...
      <div className="col-10 p-0">
       <h5 className="mt-4 mb-2 ms-2">Appointment Details</h5>
        ...
        <table className="mt-4 ms-2 mb-4">
          <tr className="m-5">
            <th  className="success-t"><a href="##" className="text-decoration-none bg-success text-white p-2">Up Coming</a></th>
            <th  className="success-t" ><a href="##" className="text-decoration-none bg-dark text-white p-2">Previous</a></th>
          </tr>
      </table>
